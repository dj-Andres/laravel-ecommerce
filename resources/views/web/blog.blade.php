                    ...
                    <div class="blog-sidebar-wrapper">
                        ...
                        <div class="blog-sidebar mb-20">
                            ...
                            <div class="recent-post mb-20">
                                <div class="recent-post-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('web/assets/img/product/product-img1.jpg')}}" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="recent-post mb-20">
                                <div class="recent-post-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('web/assets/img/product/product-img2.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="recent-post-des">
                            ...
                            <div class="recent-post mb-20">
                                <div class="recent-post-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('web/assets/img/product/product-img3.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="recent-post-des">
                    ...
                    <div class="blog-wrapper-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="blog-item mb-26">
                                    <div class="blog-thumb img-full fix">
                                        <a href="blog-details.html">
                                            <img src="{{asset('web/assets/img/blog/img_blog1.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="blog-content">
                                        ...
                                        <p>Curabitur sed diam enim. Sed varius faucibus lectus, a scelerisque massa posuere
                                            ac. Quisque dapibus, est ac...</p>
                                    </div>
                                    ...
                                    <div class="blog-thumb img-full fix">
                                        <div class="blog-gallery-slider slick-arrow-style_2">
                                            <div class="blog-single-slide">
                                                <img src="{{asset('web/assets/img/blog/img_blog4.jpg')}}" alt="">
                                            </div>
                                            <div class="blog-single-slide">
                                                <img src="{{asset('web/assets/img/blog/img_blog2.jpg')}}" alt="">
                                            </div>
                                            <div class="blog-single-slide">
                                                <img src="{{asset('web/assets/img/blog/img_blog3.jpg')}}" alt="">
                                            </div>
                                            <div class="blog-single-slide">
                                                <img src="{{asset('web/assets/img/blog/img_blog1.jpg')}}" alt="">
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="blog-item mb-26">
                                    <div class="blog-thumb embed-responsive embed-responsive-16by9">
                                        <iframe src="https://www.youtube.com/embed/DR2c266yWEA"
                ...
                <div class="col-12">
                    <div class="brand-active slick-padding slick-arrow-style">
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br1.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br2.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br3.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br4.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br5.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br6.png') }}" alt=""></a>
                        </div>
                        <div class="brand-item text-center">
                            <a href="#"><img src="{{ asset('web/assets/img/brand/br4.png') }}" alt=""></a>
                        </div>
