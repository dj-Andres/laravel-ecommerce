...
<head>
    ...
    <title>DJ Online</title>
    <link rel="shortcut icon" href="assets/img/favicon.ico" type="image/x-icon" />
    <link href="{{ asset('web/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset ('web/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{ asset('web/css/helper.min.css')}}" rel="stylesheet">
    <link href="{{ asset('web/css/plugins.css')}}" rel="stylesheet">
    <link href="{{ asset('web/css/style.css')}}" rel="stylesheet">
    <link href="{{ asset('web/css/skin-default.css')}}" rel="stylesheet" id="galio-skin">
</head>
<body>
        ...
        <div class="product-feature-wrapper mb-lg-6">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="hot-deals-wrap2 mb-30 mb-md-22 mb-sm-22 mt-xs-28">
                            <div class="section-title-2 d-flex justify-content-between mb-28">
                                 <h3>hot deals</h3>
                                 <div class="category-append"></div>
                            </div> <!-- section title end -->
                            <div class="deals-carousel-active2 slick-padding">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="main-sidebar testimonial-area pb-sm-48 mb-lg-34 mb-md-48">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="banner-statistic pt-22 pb-36">
