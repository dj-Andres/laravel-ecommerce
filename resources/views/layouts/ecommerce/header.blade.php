            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="brand-logo">
                        <a href="index-2.html">
                            <img src="{{ asset('web/assets/img/logo/logo.png') }}" alt="brand logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-9">
                        ...
                        <div class="header-middle-block">
                            ...
                            <div class="header-mini-cart">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img src="{{ asset('web/assets/img/cart/cart-1.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                    ...
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img src="{{ asset('web/assets/img/cart/cart-2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="cart-info">
